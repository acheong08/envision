...
>
  <div class="navbar-start flex-1">
    ...
    <a href="/" class="btn btn-ghost btn-xl normal-case text-xl text-purple-500"
      >Envision</a
    >
    <div class="flex-1">
      ...
      <li>
        ...
        <div class="flex md:hidden dropdown dropdown-hover dropdown-end p-0">
          ...
          >
            ...
            <li>
              <a
                href="/resources/textual_inversion"
                class="btn btn-ghost btn-sm w-full p-5">Textual Inversion</a
              >
            </li>
            <a
              href="/resources/stable_diffusion"
              class="btn btn-ghost btn-sm w-full p-5">Stable Diffusion</a
            >
          </ul>
        </div>
        <!--Resources dropdown-->
        <div class="hidden md:flex dropdown dropdown-end p-0">
          <div
            tabindex="0"
            class="m-1 btn btn-ghost btn-lg text-sm rounded-btn"
          >
